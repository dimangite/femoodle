...
class simplehtml_form extends moodleform {
    ...
    function definition() {
        ...
        // FILE MANAGER
        $mform->addElement('filemanager', 'attachments', get_string('selectlogo', 'block_fesigninsheet'), null, $filemanageropts);
...
function block_fesigninsheet_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    global $DB;
    ...
    $file = $fs->get_file($context->id, 'block_fesigninsheet', $filearea, $itemid, $filepath, $filename);
    if (!$file) {
        return false;
    }
