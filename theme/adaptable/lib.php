...
function theme_adaptable_process_css($css, $theme) {
    ...
    $defaults = array(
        '[[setting:linkcolor]]' => '#003c7d',
        '[[setting:linkhover]]' => '#014164',
        '[[setting:maincolor]]' => '#014164',
        '[[setting:backcolor]]' => '#FFFFFF',
        '[[setting:regionmaincolor]]' => '#FFFFFF',
        '[[setting:rendereroverlaycolor]]' => '#014164',
        '[[setting:rendereroverlayfontcolor]]' => '#FFFFFF',
        '[[setting:buttoncolor]]' => '#014164',
        ...
        '[[setting:blockheaderbackgroundcolor]]' => '#F0F3FE',
