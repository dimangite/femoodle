...
class xls_logging_events_testcase extends advanced_testcase {
    ...
    public function test_logging() {
        ...
        $event = \gradeexport_fexls\event\grade_exported::create($params);
        ...
        $this->assertInstanceOf('\gradeexport_fexls\event\grade_exported', $event);
        $this->assertEquals(context_course::instance($course->id), $event->get_context());
        $this->assertEquals('fexls', $event->get_export_type());
    }
}